...
| 14 | Barqarorlik + native chuqurlik (post-MVP) | 🟡 | Claude — **14A TUGADI**: Jest (28 test ✅) + ESLint/Prettier ✅ + CI ✅ + offline (Query persistence + NetInfo banner) ✅ + Maestro smoke scaffold ✅ · 14B/C/D ⬜. Batafsil ↓ |
