...
export const qk = {
  ...
  libraryExercises: () => ["library-exercises"] as const,
  customSession: (id: string) => ["custom-session", id] as const,
  customSessions: (userId: string) => ["custom-sessions", userId] as const,
